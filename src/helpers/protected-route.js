...
const ProtectedRoute = () => {
  ...
  return (
    <div className="relative flex min-h-screen antialiased">
      <nav
        className={clsx(
          'fixed top-0 left-0 z-10 h-screen w-[300px] shrink-0 overflow-y-auto bg-white bg-dotted-pattern-vertical bg-right bg-repeat-y duration-150 md:w-80 lg:sticky lg:transform-none lg:opacity-100 lg:transition-none',
          {
            '-translate-x-full opacity-0 ease-out': !headerOpen,
            'translate-x-0 opacity-100 ease-in': headerOpen
          }
        )}>
        <div className="flex bg-dotted-pattern bg-bottom bg-repeat-x py-7 px-8">
          <Link to="/">
            <svg
              ...
              viewBox="0 0 128 36"
              fill="none">
              <g clip-path="url(#clip0_356_2830)">
                <path
        ...
        <div className="flex flex-col gap-y-9 py-8">
          <div>
            <ul>
              <li>
                <Link
      ...
      <div className="relative flex max-w-full grow flex-col">
        <section className="sticky top-0 z-20 flex items-center justify-between bg-white/10 bg-bottom bg-repeat-x py-4 px-6 backdrop-blur-md md:bg-dotted-pattern md:px-9 lg:py-6">
          <div className="flex items-center gap-x-3">
            <button className="-ml-2 rounded-md p-2 text-gray-600 hover:bg-gray-50 focus:text-gray-800 xl:hidden">
